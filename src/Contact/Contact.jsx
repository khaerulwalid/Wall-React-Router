          ...
          <div className="grid grid-cols-1 md:grid-cols-2">
            <div className="p-6 mr-2 bg-gray-100 sm:rounded-lg">
              ...
              <div className="flex items-center mt-8 text-gray-600">
                ...
                <div className="ml-4 text-md tracking-wide font-semibold w-40">Praya Lombok Tengah NTB</div>
              </div>
              ...
              <div className="flex items-center mt-4 text-gray-600">
                ...
                <div className="ml-4 text-md tracking-wide font-semibold w-40">+628781909192</div>
              </div>
              ...
              <div className="flex items-center mt-2 text-gray-600">
                ...
                <div className="ml-4 text-md tracking-wide font-semibold w-40">ckrwislam@gmail.com</div>
              </div>
            </div>
